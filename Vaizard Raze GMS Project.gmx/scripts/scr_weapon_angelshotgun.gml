...
if keyboard_check_pressed(global.keybind[KEY_SHOOT]) && bullets1>0
    {
    projectile=scr_projectile_spawn(x+(obj_player.facedir*16),y-36,PROJ_BUSTERSHOT,obj_player.team,damage1,damage1,damage1,obj_player.facedir,0,obj_player.color_torso);
...
if keyboard_check_released(global.keybind[KEY_SHOOT]) && charge1>max_charge1
    {
    projectile=scr_projectile_spawn(x+(obj_player.facedir*16),y-36,PROJ_BUSTERCHARGE,obj_player.team,damage1_2,damage1_2,damage1_2,obj_player.facedir,0,obj_player.color_torso);
